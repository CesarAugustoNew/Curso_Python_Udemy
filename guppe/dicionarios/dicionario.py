...
# O metodo fromkeys recebe dois parametros: um interavel e um valor. Ele vai gerar para cada valor do iteravel uma chave e ira atribuir a esta chave o valor informado.
